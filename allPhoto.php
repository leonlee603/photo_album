...
// Prepare to display all photos in database
$all_photo_query = "SELECT * FROM albumphoto ORDER BY ap_date DESC";
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mx-auto px-0">
                    <div class="row">
                        <?php while ($row_all_photo = $all_photo->fetch_array(MYSQLI_ASSOC)) { ?>
                            <div class="col-4 col-sm-4 col-md-3 col-lg-2 mx-0 px-0">
                                <div class="card rounded-0 m-0">
                                    <div class="album-image">
                                        <img class="card-image-top img-fluid" src="photos/<?php echo $row_all_photo['ap_picurl'] ?>" alt="<?php echo $row_all_photo['ap_subject'] ?>">
                                    </div>
                                    <!-- Image overlay with the view number of that picture -->
                                    <a href="?action=hits&id=<?php echo $row_all_photo["ap_id"];?>&aid=<?php echo $row_all_photo['album_id'];?>">
                                        <div class="card-img-overlay d-flex flex-column justify-content-end px-3 pb-0 album-image-hits">
                                            <p class="text-white text-shadow mb-2"><?php echo $row_all_photo['ap_hits'] ?>&nbsp;<i class="far fa-eye"></i>&nbsp;&nbsp;<?php echo $row_all_photo['ap_comment'] ?>&nbsp;<i class="far fa-comment"></i></p>
                                        </div>
